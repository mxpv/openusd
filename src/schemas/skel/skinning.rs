...
//!
//! All matrix data uses USD's textual `matrix4d` layout (row-major
//! flat `[f64; 16]`). The 4×4 algebra itself lives in [`crate::math`];
//! this module imports those helpers and adds the skinning-specific
//! transforms on top.
