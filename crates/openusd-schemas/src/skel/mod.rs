...
//! ```
//!
//! [`SkelRoot`] and [`Skeleton`] are [`geom::Boundable`](crate::geom)
...
//!
//! ```
//! use openusd_schemas::skel::{self, Skeleton, SkeletonResolver};
...
crate::common::impl_token_value!(SkinningMethod, InfluenceInterpolation);
